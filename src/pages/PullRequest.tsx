      ...
      <div className="border-b border-primary-light/20 mb-6">
        <nav className="flex gap-1 -mb-px overflow-x-auto">
          {[
            ...
            { label: "Commits", icon: GitCommit, count: commits.length },
            { label: "Files changed", icon: FileCode, count: 47 },
          ].map((tab) => (
            <button
              key={tab.label}
          ...
          {activeTab === "Conversation" && (
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 py-2">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 bg-diff-add-bg rounded-full border border-diff-add-border text-xs font-medium text-diff-add-line">
                  <GitMerge size={14} />
                  <span>PR merged into main</span>
                </div>
                <div className="flex-1 h-px bg-primary-light/20" />
              </div>
            </div>
              ...
              <div className="border border-primary-light/20 rounded-lg overflow-hidden">
                ...
                <div className="p-4 md:p-5">
                  ...
                  <div className="text-sm text-primary-medium leading-relaxed space-y-3">
                    <p>
                      This PR implements the four technical challenges using
                      React, focusing on:
                    </p>
